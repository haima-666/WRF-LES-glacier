...
def ranwu():
    ...
    shp_file = 'glac_boundary/ranwu.shp'  # 替换为你的文件路径
    ...
    fig, axes = plt.subplots(nrows=2, ncols=4, figsize=(20, 16), subplot_kw={'projection': wrf_proj})

    # #p94
    # lonrange = (96.9483, 97.0447)
    # latrange = (29.3400, 29.427)

    # # laigu local
    # lonrange = (96.5155, 96.8496)
    # latrange = (29.0656, 29.4133)

    # p4
    lonrange = (96.8374, 97.0281)
    latrange = (29.0871, 29.2852)
    ...
    for i, ax in enumerate(axes.flat):
        ...
        t2_clip = clip_vari(t2, (lonrange[0] - 0.05, lonrange[1] + 0.05), (latrange[0] - 0.05, latrange[1] + 0.05))
        t2ice_clip = clip_vari(t2ice, (lonrange[0] - 0.05, lonrange[1] + 0.05),
                               (latrange[0] - 0.05, latrange[1] + 0.05))
    ...
    plt.savefig('./Figure/p4icebias240_2D.jpg', dpi=300)
    # plt.show()
